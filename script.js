...
const formatMovementDate = function (date, locale) {
  ...
  // }
  // no need for else statement since this won't run if any of the ifs are true
...
const startLogOutTimer = function () {
  // this was put as a different function so that the timer gets called immediately
  const tick = function () {
